    ...
    return (
      <div>
        ...
        <Container fluid>
          ...
          <Carousel className="carouselStyle ml-1">
          ...
          <div className="boxOne"><p>3. Edit and Add to your list</p></div>
            ...
            <div className="searchbtn ml-4">
              ...
              <h3 className="mb-5 mt-3" ><u>My Grocery List</u></h3>
                ...
                <img alt="groceries-picture" style={{ width:150, height:150, position:"absolute", bottom:10, right:10}} src="http://www.pngmart.com/files/7/Groceries-Transparent-Images-PNG.png"></img>
              </div>
